...
const studentNavItems: NavItem[] = [
  ...
  { name: 'Subjects', href: '/student/subjects', icon: <BookMarked className="w-5 h-5" /> },
  { name: 'Study Materials', href: '/student/materials', icon: <FileText className="w-5 h-5" /> },
  { name: 'Profile', href: '/student/profile', icon: <User className="w-5 h-5" /> },
  { name: 'Settings', href: '/student/settings', icon: <Settings className="w-5 h-5" /> },
];

const teacherNavItems: NavItem[] = [
  { name: 'Dashboard', href: '/teacher/dashboard', icon: <Home className="w-5 h-5" /> },
  { name: 'Students', href: '/teacher/students', icon: <Users className="w-5 h-5" /> },
  { name: 'Subjects', href: '/teacher/subjects', icon: <BookMarked className="w-5 h-5" /> },
  { name: 'Units', href: '/teacher/units', icon: <FolderOpen className="w-5 h-5" /> },
  { name: 'Study Materials', href: '/teacher/materials', icon: <FileText className="w-5 h-5" /> },
  { name: 'Profile', href: '/teacher/profile', icon: <User className="w-5 h-5" /> },
  { name: 'Settings', href: '/teacher/settings', icon: <Settings className="w-5 h-5" /> },
];
